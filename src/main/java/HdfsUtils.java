...
public class HdfsUtils {
     ...
     * 기본 HDFS URL의 Prefix
     */
    public static final String HDFS_URL_PREFIX = "hdfs://127.0.0.1:9000";
     ...
     * @return FileSystem
     */
    public static FileSystem getFileSystem(String fsDefaultName) throws IOException{
     ...
     */
    public static boolean isDir(FileSystem fs, String path) throws Exception{
     ...
     */
    public static boolean isFile(FileSystem fs, String path) throws Exception{
        return fs.isFile(new Path(path));
    }
...
//            throw new FileSystemException(ExceptionUtils.getMessage("지정한 '{}' 파일을 로딩할 수 없습니다.", path), e);
     ...
     * @return FileSystem
     */
    public static FileSystem getFileSystemFromPath(String path) throws IOException
    {
